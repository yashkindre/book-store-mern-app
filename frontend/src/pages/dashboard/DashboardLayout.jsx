        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span className="font-semibold">Yash Kindre</span>
              <span className="text-sm text-gray-600">Developer</span>
            </div>
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://media.licdn.com/dms/image/v2/D4D03AQFewpvGfzHbtg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1715265580359?e=2147483647&v=beta&t=mzjL_-SwMTyQG0WUxHJp82uJxIGH4qUSPW_YT7sGU4k" alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
